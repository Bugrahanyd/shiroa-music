      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="theme-card backdrop-blur-xl bg-opacity-50 rounded-3xl p-8 shadow-2xl border-2">
          ...
          <div className="text-center mb-8">
            ...
            <p className="theme-text-secondary">Create your account and start creating</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <label className="text-sm theme-text-secondary font-medium">Full Name</label>
              <input
                type="text"
                required
                value={name}
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                placeholder="••••••••"
              />
              <p className="text-xs theme-text-secondary">Minimum 6 characters</p>
            </div>
          ...
          <div className="text-center">
            <p className="theme-text-secondary text-sm">
              ...
              <Link href="/login" className="theme-accent font-semibold hover:opacity-80 transition-opacity">
                Sign In
              </Link>
            </p>
          </div>
