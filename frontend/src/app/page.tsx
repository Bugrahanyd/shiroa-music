      ...
      <div className="absolute bottom-6 left-0 right-0 text-center px-4 z-10">
        <p className="text-white/50 text-sm">
          ...
          <a 
            ...
            className="font-bold bg-gradient-to-r from-orange-400 via-purple-400 via-pink-400 to-cyan-400 bg-clip-text text-transparent hover:scale-105 transition-transform inline-block"
          >
            HYDRABON
          </a>
        </p>
